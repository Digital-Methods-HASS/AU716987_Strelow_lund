...
```{r}
#Vi skal finde en stopordsliste, som vi kan tilskrive Herman Bangs Roman
...
negativ_keywords <- c(
  ...
  "tummel", "elektrisk", "travlhed", "illusion", "tomhed", "overflade", "marmorpuds", "luften", "electronic", "mørket", "støjen", "København"
)
